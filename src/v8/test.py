...
DEFAULT_MODEL_PATH = OUTPUT_DIR / "models" / "model8.pth"
DEFAULT_THRESHOLD_PATH = OUTPUT_DIR / "models" / "model8_threshold.json"
...
DEFAULT_RESULTS_PATH = OUTPUT_DIR / "logs" / f"test_results_v8_{RUN_TIMESTAMP}.csv"
DEFAULT_SUMMARY_PATH = OUTPUT_DIR / "logs" / f"test_summary_v8_{RUN_TIMESTAMP}.csv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate v8 gated multi-evidence CNN model on test set.")
    parser.add_argument("--model-path", type=Path, default=DEFAULT_MODEL_PATH, help="Path to trained v8 model.")
...
def main() -> None:
    ...
    log_message(start_time, "Running v8 test evaluation...")
    ...
    log_message(start_time, "V8 Test Results:")
