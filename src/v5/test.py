...
DEFAULT_MODEL_PATH = OUTPUT_DIR / "models" / "model5.pth"
DEFAULT_THRESHOLD_PATH = OUTPUT_DIR / "models" / "model5_threshold.json"
...
DEFAULT_RESULTS_PATH = OUTPUT_DIR / "logs" / f"test_results_v5_{RUN_TIMESTAMP}.csv"
DEFAULT_SUMMARY_PATH = OUTPUT_DIR / "logs" / f"test_summary_v5_{RUN_TIMESTAMP}.csv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate v5 CNN model on test set.")
    parser.add_argument("--model-path", type=Path, default=DEFAULT_MODEL_PATH, help="Path to trained v5 model.")
...
def main() -> None:
    ...
    print("Running v5 test evaluation...")
