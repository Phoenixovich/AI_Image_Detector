...
DEFAULT_MODEL_PATH = OUTPUT_DIR / "models" / "model6.pth"
DEFAULT_THRESHOLD_PATH = OUTPUT_DIR / "models" / "model6_threshold.json"
...
DEFAULT_RESULTS_PATH = OUTPUT_DIR / "logs" / f"test_results_v6_{RUN_TIMESTAMP}.csv"
DEFAULT_SUMMARY_PATH = OUTPUT_DIR / "logs" / f"test_summary_v6_{RUN_TIMESTAMP}.csv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate v6 CNN model on test set.")
    parser.add_argument("--model-path", type=Path, default=DEFAULT_MODEL_PATH, help="Path to trained v6 model.")
...
def main() -> None:
    ...
    log_message(start_time, "Running v6 test evaluation...")
    ...
    log_message(start_time, "V6 Test Results:")
