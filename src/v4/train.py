...
MODEL_PATH = OUTPUT_DIR / "models" / "model4.pth"
THRESHOLD_PATH = OUTPUT_DIR / "models" / "model4_threshold.json"
LOG_PATH = OUTPUT_DIR / "logs" / "training_log_v4.csv"


def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Train v4 CNN with balanced sampling and threshold tuning.")
...
# must run with full 50 epochs, its promising