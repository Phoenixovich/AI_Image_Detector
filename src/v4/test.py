...
DEFAULT_MODEL_PATH = OUTPUT_DIR / "models" / "model4.pth"
DEFAULT_THRESHOLD_PATH = OUTPUT_DIR / "models" / "model4_threshold.json"
DEFAULT_TEST_DIR = PROJECT_ROOT / "dataset" / "processed" / "test"
DEFAULT_TEST_LABELS_PATH = PROJECT_ROOT / "dataset" / "raw" / "test_labels.csv"
DEFAULT_RESULTS_PATH = OUTPUT_DIR / "logs" / "test_results_v4.csv"
DEFAULT_SUMMARY_PATH = OUTPUT_DIR / "logs" / "test_summary_v4.csv"
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(description="Evaluate v4 CNN model on test set.")
    parser.add_argument("--model-path", type=Path, default=DEFAULT_MODEL_PATH, help="Path to trained v4 model.")
